...
class CreateCinemaSchema extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('showrooms', function (Blueprint $table) {
            $table->id();
            $table->string('title', 255);
            $table->integer('seating_chart_id')->unsigned();
            $table->timestamps();
        });
        ...
        Schema::create('seating_chart', function (Blueprint $table) {
            $table->id();
            $table->integer('seat_type')->unsigned();
            $table->foreign('seat_type')->references('id')->on('seat_types');
        ...
        Schema::create('seat_type_percentage_premiums', function (Blueprint $table) {
            $table->id();
            $table->integer('seat_type')->unsigned();
            $table->foreign('seat_type')->references('id')->on('seat_types');
        ...
        Schema::create('movie_show_bookings', function (Blueprint $table) {
            $table->id();
